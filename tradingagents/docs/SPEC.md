# TradingAgents 项目规格文档

> 版本: 0.2.1 | 日期: 2026-04-05 | Python ≥ 3.10

## 1. 项目概述

TradingAgents 是一个基于多智能体 LLM 的金融交易分析框架。系统模拟真实交易公司的组织架构，通过多个专业化 AI Agent 协作完成股票分析、投资辩论、风险评估，最终输出结构化交易决策。
...
输出到 `tradingagents/docs/reports/{ticker}_{date}_report.md`，包含：
- 各分析师完整报告
- 投资辩论 (多头/空头/裁判)
- 风险辩论 (激进/保守/中性/裁判)
- 最终交易决策
